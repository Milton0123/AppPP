...
import com.example.apppp.databinding.ItemRvAzulBinding
...
class ProductAdapter(private val productList: List<ProductData>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_rv_azul, parent, false)
...
class ProductHolder(view: View) : RecyclerView.ViewHolder(view) {
    private val binding = ItemRvAzulBinding.bind(view)
